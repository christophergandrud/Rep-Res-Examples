...
PackagesUsed <- c("devtools", "knitr", "ggplot2", "repmis")
...
This document was created using the R version 2.15.2 and the R package \emph{knitr} \citep{R-knitr}. It also relied on the R packages \emph{devtools} \citep{R-devtools}, \emph{ggplot2} \citep{R-ggplot2}, and \emph{repmis} \citep{R-repmis}. The document can be completely reproduced from source files available on GitHub at: \url{https://github. com/christophergandrud/Rep-Res-Examples}.
